...
def verify_all():
    ...
    print(f"  TOTAL RECORDS ACROSS FINAL LISTS: {total_final:>5} (Expected: 90,027)")
    assert total_final == 90027, f"Total mismatch: got {total_final}, expected 90027"
